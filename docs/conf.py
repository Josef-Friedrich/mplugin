...
ver_ns = {}
ver_path = os.path.abspath("../nagiosplugin/version.py")
...
# The unique identifier of the text. This can be an ISBN or the project
# homepage.
# epub_identifier = ''
